...
export default function DownloadJson() {
    ...
    const saveTemplate = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    return (React.createElement(Tooltip, { title: "Save Template" },
        React.createElement(IconButton, { onClick: saveTemplate },
