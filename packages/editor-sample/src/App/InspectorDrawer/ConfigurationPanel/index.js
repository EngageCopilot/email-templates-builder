...
function renderMessage(val) {
  return React.createElement(
    Box,
    { sx: { m: 3, p: 1, border: '1px dashed', borderColor: 'divider' } },
...
export default function ConfigurationPanel() {
  ...
  switch (type) {
    case 'Avatar':
      return React.createElement(AvatarSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Button':
      return React.createElement(ButtonSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'ColumnsContainer':
      return React.createElement(ColumnsContainerSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Container':
      return React.createElement(ContainerSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Divider':
      return React.createElement(DividerSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Heading':
      return React.createElement(HeadingSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Html':
      return React.createElement(HtmlSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Image':
      return React.createElement(ImageSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'EmailLayout':
      return React.createElement(EmailLayoutSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Spacer':
      return React.createElement(SpacerSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
    case 'Text':
      return React.createElement(TextSidebarPanel, {
        key: selectedBlockId,
        data: data,
        setData: (data) => setBlock({ type, data }),
      });
