...
export default function RawSliderInput(_a) {
  var { iconLabel, value, setValue, units } = _a,
    props = __rest(_a, ['iconLabel', 'value', 'setValue', 'units']);
  return React.createElement(
    Stack,
    { direction: 'row', alignItems: 'center', spacing: 2, justifyContent: 'space-between', width: '100%' },
    ...
    React.createElement(
      ...
      React.createElement(
        Typography,
        { variant: 'body2', color: 'text.secondary', sx: { lineHeight: 1 } },
        value,
        units
      )
    )
