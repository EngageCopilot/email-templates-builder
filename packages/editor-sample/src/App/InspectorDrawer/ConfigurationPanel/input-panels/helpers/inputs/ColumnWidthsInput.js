...
export default function ColumnWidthsInput({ defaultValue, onChange }) {
  ...
  if (columnsCountValue === 3) {
    column3 = React.createElement(TextDimensionInput, {
      label: 'Column 3',
      defaultValue: currentValue === null || currentValue === void 0 ? void 0 : currentValue[2],
      onChange: (v) => {
        setIndexValue(2, v);
      },
    });
  ...
  return React.createElement(
    ...
    React.createElement(TextDimensionInput, {
      label: 'Column 1',
      defaultValue: currentValue === null || currentValue === void 0 ? void 0 : currentValue[0],
      onChange: (v) => {
        setIndexValue(0, v);
      },
    }),
    React.createElement(TextDimensionInput, {
      label: 'Column 2',
      defaultValue: currentValue === null || currentValue === void 0 ? void 0 : currentValue[1],
      onChange: (v) => {
        setIndexValue(1, v);
      },
    }),
