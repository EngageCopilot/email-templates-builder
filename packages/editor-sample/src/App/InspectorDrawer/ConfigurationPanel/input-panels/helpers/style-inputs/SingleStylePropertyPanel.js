...
export default function SingleStylePropertyPanel({ name, value, onChange }) {
  ...
  switch (name) {
    case 'backgroundColor':
      return React.createElement(NullableColorInput, {
    ...
    case 'fontFamily':
      return React.createElement(NullableFontFamily, {
        label: 'Font family',
        defaultValue: defaultValue,
        onChange: handleChange,
      });
    case 'fontSize':
      return React.createElement(FontSizeInput, {
        label: 'Font size',
        defaultValue: defaultValue,
        onChange: handleChange,
      });
    case 'fontWeight':
      return React.createElement(FontWeightInput, {
        label: 'Font weight',
        defaultValue: defaultValue,
        onChange: handleChange,
      });
    case 'textAlign':
      return React.createElement(TextAlignInput, {
        label: 'Alignment',
        defaultValue: defaultValue,
        onChange: handleChange,
      });
    case 'padding':
      return React.createElement(PaddingInput, {
        label: 'Padding',
        defaultValue: defaultValue,
        onChange: handleChange,
      });
