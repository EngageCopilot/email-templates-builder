...
export default function ColorInput({ label, defaultValue, onChange, nullable }) {
  ...
  const renderOpenButton = () => {
    if (value) {
      return React.createElement(ButtonBase, {
        ...
        sx: Object.assign(Object.assign({}, BUTTON_SX), { bgcolor: value }),
      });
    }
    return React.createElement(
      ButtonBase,
      { onClick: handleClickOpen, sx: Object.assign({}, BUTTON_SX) },
  ...
  return React.createElement(
    ...
    React.createElement(Stack, { direction: 'row', spacing: 1 }, renderOpenButton(), renderResetButton()),
    React.createElement(
      Menu,
      {
        anchorEl: anchorEl,
