...
export default function TuneMenu({ blockId }) {
  ...
  const handleDeleteClick = () => {
    ...
    for (const [id, b] of Object.entries(nDocument)) {
      ...
      switch (block.type) {
        case 'EmailLayout':
          nDocument[id] = Object.assign(Object.assign({}, block), {
            data: Object.assign(Object.assign({}, block.data), {
        ...
        case 'Container':
          nDocument[id] = Object.assign(Object.assign({}, block), {
            data: Object.assign(Object.assign({}, block.data), {
              props: Object.assign(Object.assign({}, block.data.props), {
                childrenIds: filterChildrenIds(
                  (_a = block.data.props) === null || _a === void 0 ? void 0 : _a.childrenIds
                ),
              }),
            }),
          });
        ...
        case 'ColumnsContainer':
          nDocument[id] = {
            ...
            data: {
              ...
              props: Object.assign(Object.assign({}, block.data.props), {
                columns:
                  (_c = (_b = block.data.props) === null || _b === void 0 ? void 0 : _b.columns) === null ||
                  _c === void 0
                    ? void 0
                    : _c.map((c) => ({
  ...
  return React.createElement(
    Paper,
    { sx: sx, onClick: (ev) => ev.stopPropagation() },
    React.createElement(
      Stack,
      null,
      React.createElement(
        Tooltip,
        { title: 'Move up', placement: 'left-start' },
        React.createElement(
          IconButton,
          { onClick: () => handleMoveClick('up'), sx: { color: 'text.primary' } },
          React.createElement(ArrowUpwardOutlined, { fontSize: 'small' })
        )
      ),
      React.createElement(
        Tooltip,
        { title: 'Move down', placement: 'left-start' },
        React.createElement(
          IconButton,
          { onClick: () => handleMoveClick('down'), sx: { color: 'text.primary' } },
          React.createElement(ArrowDownwardOutlined, { fontSize: 'small' })
        )
      ),
      React.createElement(
        Tooltip,
        { title: 'Delete', placement: 'left-start' },
        React.createElement(
          IconButton,
          { onClick: handleDeleteClick, sx: { color: 'text.primary' } },
