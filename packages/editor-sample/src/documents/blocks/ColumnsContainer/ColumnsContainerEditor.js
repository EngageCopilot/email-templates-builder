...
export default function ColumnsContainerEditor({ style, props }) {
  ...
  const _d = props !== null && props !== void 0 ? props : {},
    { columns } = _d,
    restProps = __rest(_d, ['columns']);
  ...
  return React.createElement(BaseColumnsContainer, {
    props: restProps,
    style: style,
    columns: [
      React.createElement(EditorChildrenIds, {
        childrenIds:
          (_a = columns === null || columns === void 0 ? void 0 : columns[0]) === null || _a === void 0
            ? void 0
            : _a.childrenIds,
      ...
      React.createElement(EditorChildrenIds, {
        childrenIds:
          (_b = columns === null || columns === void 0 ? void 0 : columns[1]) === null || _b === void 0
            ? void 0
            : _b.childrenIds,
      ...
      React.createElement(EditorChildrenIds, {
        childrenIds:
          (_c = columns === null || columns === void 0 ? void 0 : columns[2]) === null || _c === void 0
            ? void 0
            : _c.childrenIds,
